						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">视频编辑</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">视频编辑</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/video_doupdate" class="form-horizontal" method="post" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<img src='{{$video['image_path']}}' id="fileImg" width='255'/>
														<input type="file" id="goods_file" name="goods_file"/>
														<input type="hidden" id="video_hidden" name="video_hidden" value="{{$video['id']}}"/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="describe" value="{{$video['description']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_path" value="{{$video['video_path']}}" class="m-wrap large" />

														<span class="help-inline">请输入视频链接</span>
