						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几服务标签设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几服务标签设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/service/label/doUpdate/{{$label['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">匠几服务标签id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几服务标签名称</label>

													<div class="controls">

														<input type="text" name="label_name" value="{{$label['label_name']}}" class="m-wrap large" />

														<span class="help-inline">请输入匠几服务标签名称</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="mid" value="{{$label['service_id']}}" readonly class="m-wrap large" />
