						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果动态管理</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果动态新增</a></li>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">动态标题<span class="required">*</span></label>

													<div class="controls">

														<input type="text" name="news_title" placeholder="请输入动态标题" class="m-wrap huge" />

														<span class="help-inline">请输入动态标题</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="date" name="news_date" class="m-wrap huge"/>
