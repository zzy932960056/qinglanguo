							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几动态新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="title" placeholder="请输入匠几动态标题" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="date_time" placeholder="请输入匠几动态日期" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="describe" placeholder="请输入匠几动态简介摘要" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="news_pic" placeholder="请输入匠几动态封面图路径" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="label" placeholder="请输入匠几动态标签" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="category" placeholder="请输入匠几动态分类" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="radio" name="is_hot" value="1" class="m-wrap huge" />热门

														<input type="radio" name="is_hot" value="0" class="m-wrap huge" />不热门
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="hot_pic" placeholder="请输入热门封面图路径" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="hot_desp" placeholder="请输入热门动态简介摘要" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="template_no" placeholder="请输入详情模板编号" class="m-wrap huge" />
