					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_bao/first">觅宝首推信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">觅宝首推设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅宝首推设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅宝首推设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_bao/first/doUpdate/{{$bao['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅宝首推id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">觅宝首推图路径</label>

													<div class="controls">

														<input type="text" name="img_path" value="{{$bao['img_path']}}" class="m-wrap large" />

														<span class="help-inline">请输入觅宝首推图路径</span>
