						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅尚杂志页设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚杂志页设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/magazine/doUpdate/{{$magazine['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚杂志页id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚杂志页路径</label>

													<div class="controls">

														<input type="text" name="magazine_pic" value="{{$magazine['magazine_pic']}}" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志页路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">当前杂志id</label>

													<div class="controls">

														<input type="text" name="zid" value="{{$magazine['shang_id']}}" readonly class="m-wrap large" />
