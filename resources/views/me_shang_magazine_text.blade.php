...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_shang/index">觅尚杂志详情</a>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅尚杂志文字列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/me_shang/text/index/update/{{$sh->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/me_shang/text/index/insert/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_shang/text/index/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除杂志段落成功');
								location.href = "/me_shang/text/index/"+shangid;
