...
<body class="page-header-fixed">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$ne->big_paragraph}}</td>

											<td>{{$ne->small_paragraph}}</td>

											<td><img src="{{$ne->picture1}}" width="255"/></td>

											<td><img src="{{$ne->picture2}}" width="255"/></td>

											<td id="jiangjiid">{{$ne->news_id}}</td>

											<td><a href="/admin/news/third/index/update/{{$ne->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/news/third/index/first/"+hid;
				}
			)
		...
		$("#sample_editable_2_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/news/third/index/second/"+hid;
				}
			)
		...
		$("#sample_editable_3_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/news/third/index/third/"+hid;
				}
			)
		...
		$("#sample_editable_4_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/news/third/index/forth/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/admin/news/third/index/dodelete",
						type:"post",
						data:{'mid':data},
