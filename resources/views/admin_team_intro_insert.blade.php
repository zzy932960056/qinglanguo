						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几团队成员简介新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几团队成员简介新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/team/introduce/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">匠几团队成员介绍</label>

													<div class="controls">

														<input type="text" name="staff_intro" placeholder="请输入匠几团队成员介绍" class="m-wrap huge" />

														<span class="help-inline">请输入匠几团队成员介绍</span>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几团队成员id</label>

													<div class="controls">

														<input type="text" name="intro_id" value="{{$intro_id}}" readonly class="m-wrap huge" />
