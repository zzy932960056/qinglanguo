...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_shang/index">觅尚杂志图片管理</a> 
							...
							<li>
								...
								<a href="/me_shang/index">觅尚杂志图片详情</a>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅尚杂志图片列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$sh->magazine_pic}}</td>

											<td><img src="{{$sh->magazine_pic}}" width="255"/></td>

											<td>{{$sh->magazine_page}}</td>

											<td id="shangid">{{$sh->shang_id}}</td>

											<td><a href="/me_shang/magazine/update/{{$sh->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/me_shang/magazine/insert/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_shang/magazine/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除杂志页成功');
								location.href = "/me_shang/magazine/index/"+shangid;
