						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果动态详情视频新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果动态详情视频新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/details/video/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">青蓝果动态详情视频路径</label>

													<div class="controls">

														<input type="text" name="news_video" placeholder="请输入青蓝果动态详情视频路径" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态详情视频路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">青蓝果动态详情视频封面图路径</label>

													<div class="controls">

														<input type="text" name="news_video_pic" placeholder="请输入青蓝果动态详情视频封面图路径" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态详情视频封面图路径</span>
