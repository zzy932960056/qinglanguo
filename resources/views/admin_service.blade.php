					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几服务列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$se->service_img}}" width="255"/></td>

											<td><img src="{{$se->service_mobile}}" width="255"/></td>

											<td>{{$se->service_title}}</td>

											<td>{{$se->service_desc}}</td>

											<td><a href="/admin/service/label/{{$se->id}}">匠几服务标签</a></td>

											<td><a href="/admin/service/update/{{$se->id}}">编辑</a></td>
