...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅尚首推杂志列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$sh->magazine_pic}}" width="255"></img></td>

											<td>{{$sh->magazine_page}}</td>

											<td id="shangid">{{$sh->shang_id}}</td>

											<td><a href="/me_shang/cover/magazine/update/{{$sh->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/me_shang/cover/magazine/insert/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_shang/cover/magazine/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除觅尚首推杂志页成功');
								location.href = "/me_shang/cover/magazine/"+shangid;
