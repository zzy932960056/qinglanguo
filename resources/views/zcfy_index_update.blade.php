						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">中财福源固资信息设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">中财福源固资信息设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/zcfy/index/doupdate/{{$info['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="asset_tag" value="{{$info['asset_tag']}}" class="m-wrap huge" readonly/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="category" id="category" value="{{$info['category']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="asset_name" id="asset_name" value="{{$info['asset_name']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="unit" value="{{$info['unit']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="model" value="{{$info['model']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="place" value="{{$info['place']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="status" value="{{$info['status']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="picture" value="{{$info['picture']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="remark" value="{{$info['remark']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="qr_code" value="{{$info['qr_code']}}" class="m-wrap huge" />
