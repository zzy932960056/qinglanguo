					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/banner/banner_pic">banner图管理</a> 
							...
							<li>
								...
								<a href="/banner/banner_pic">banner图</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">banner图设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">banner图设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">banner图设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/banner/banner_pic/doupdate/{{$banner_data['id']}}" class="form-horizontal" method="post">
