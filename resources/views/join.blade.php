					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>合作伙伴列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$jo->pic_path}}" width="255"/></td>

											<td>{{$jo->introduce}}</td>

											<td><a href="/join/update/{{$jo->id}}">编辑</a></td>
