					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_xiu/image_right">觅秀右图管理</a> 
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅秀右图信息列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->image_title}}</td>

											<td>{{$in->image_pic}}</td>

											<td><img src="{{$in->image_pic}}"/></td>

											<td>{{$in->image_slogen}}</td>

											<td><a href="/me_xiu/image_right/update/{{$in->id}}">编辑</a></td>
