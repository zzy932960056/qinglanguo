					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/jiangji">匠几服务简介管理</a> 
							...
							<li>
								...
								<a href="/admin/jiangji">匠几服务简介</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">匠几服务简介新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几服务简介详情设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几服务简介详情新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/jiangji/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">匠几服务简介</label>

													<div class="controls">

														<input type="text" name="introduce" placeholder="请输入匠几服务标签" class="m-wrap huge" />

														<span class="help-inline">请输入匠几服务简介</span>
