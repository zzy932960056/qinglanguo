				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-社会链接管理 <small>青蓝果教育-社会链接</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-社会链接</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="25%"><img src="{{$so->soc_pic1}}"/></td>

											<td>{{$so->soc_text1}}</td>

											<td>{{$so->soc_text2}}</td>

											<td width="25%"><img src="{{$so->soc_pic2}}"/></td>

											<td><a href="/admin/education/social_update/{{$so->id}}">编辑</a></td>
