					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几环创设计列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$case_env['env_pic1']}}" width="355"/></td>

											<td>{{$case_env['env_text1']}}</td>

											<td><img src="{{$case_env['env_pic2']}}" width="355"/></td>

											<td>{{$case_env['env_text2']}}</td>

											<td><img src="{{$case_env['env_pic3']}}" width="355"/></td>

											<td>{{$case_env['env_text3']}}</td>

											<td><img src="{{$case_env['env_pic4']}}" width="355"/></td>

											<td>{{$case_env['env_text4']}}</td>

											<td><a href="/admin/case/env/update/{{$case_env['id']}}">编辑</a></td>
