				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-师资力量管理 <small>青蓝果教育-师资力量</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-师资力量</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="15%"><img src="{{$te->k_pic1}}"/></td>
											...
											<td width="25%"><img src="{{$te->k_pic2}}"/></td>

											<td><a href="/admin/education/teach_update/{{$te->id}}">编辑</a></td>
