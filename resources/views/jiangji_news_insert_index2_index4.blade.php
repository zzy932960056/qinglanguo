								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index2/forth/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="image_text_pic1" placeholder="请输入3张并列图图1路径" class="m-wrap huge" />

														<span class="help-inline">请输入3张并列图图1路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="image_text_pic2" placeholder="请输入3张并列图图2路径" class="m-wrap huge" />

														<span class="help-inline">请输入3张并列图图2路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="image_text_pic3" placeholder="请输入3张并列图图3路径" class="m-wrap huge" />

														<span class="help-inline">请输入3张并列图图3路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="image_text_title1" placeholder="请输入3张并列图图1标题" class="m-wrap huge" />

														<span class="help-inline">请输入3张并列图图1标题</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="image_text_title2" placeholder="请输入3张并列图图2标题" class="m-wrap huge" />

														<span class="help-inline">请输入3张并列图图2标题</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="image_text_title3" placeholder="请输入3张并列图图3标题" class="m-wrap huge" />

														<span class="help-inline">请输入3张并列图图3标题</span>
