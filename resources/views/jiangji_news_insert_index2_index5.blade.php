								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index2/fifth/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">右大左小图左图路径</label>

													<div class="controls">

														<input type="text" name="right_big_pic1" placeholder="请输入右大左小图左图路径" class="m-wrap huge" />

														<span class="help-inline">请输入右大左小图左图路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">右大左小图右图路径</label>

													<div class="controls">

														<input type="text" name="right_big_pic2" placeholder="请输入右大左小图右图路径" class="m-wrap huge" />

														<span class="help-inline">请输入右大左小图右图路径</span>
