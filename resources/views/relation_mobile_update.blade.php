					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/relation">联系匠几大图管理</a> 
							...
							<li>
								...
								<a href="/admin/relation">联系匠几大图</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">联系匠几大图设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">联系匠几大图设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">联系匠几大图设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/relation_mobile/doupdate/{{$jiangji_relation['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">联系匠几大图id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="rid" type="text" value="{{$jiangji_relation['id']}}" disabled/>

														<span class="help-inline">联系匠几大图id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">联系匠几大图路径</label>

													<div class="controls">

														<input type="text" name="contact_mobile" value="{{$jiangji_relation['contact_mobile']}}" class="m-wrap large" />
