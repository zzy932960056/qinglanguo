							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅宝视频新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_bao/video/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_img" placeholder="请输入觅宝视频封面图路径" class="m-wrap large" />

														<span class="help-inline">请输入觅宝视频封面图路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_title" placeholder="请输入觅宝视频标题" class="m-wrap large" />

														<span class="help-inline">请输入觅宝视频标题</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_content" placeholder="请输入觅宝视频描述" class="m-wrap large" />

														<span class="help-inline">请输入觅宝视频描述</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_path" placeholder="请输入觅宝视频路径" class="m-wrap large" />

														<span class="help-inline">请输入觅宝视频路径</span>
