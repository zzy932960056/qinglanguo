				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/admin/video_upload">视频新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">视频新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">视频新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/video_doinsert" class="form-horizontal" method="post" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="describe" placeholder="请输入视频描述" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="link" placeholder="请输入视频链接" class="m-wrap large" />
