								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/details/video/doupdate/{{$details['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">青蓝果动态视频路径</label>

													<div class="controls">

														<input type="text" name="news_video" value="{{$details['news_video']}}" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态视频路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">青蓝果动态视频封面图路径</label>

													<div class="controls">

														<input type="text" name="news_video_pic" value="{{$details['news_video_pic']}}" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态视频封面图路径</span>
