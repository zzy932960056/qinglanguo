					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅闻封面列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/me_news/cover/index/{{$news->id}}">图文详情</a></td>

											<td><a href="/me_news/cover/update/{{$news->id}}">编辑</a></td>
