						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几合作流程设置</span>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/jiangji/cooperation/doupdate/{{$cooperation['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">匠几合作流程id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="cid" type="text" value="{{$cooperation['id']}}" disabled/>

														<span class="help-inline">匠几合作流程id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几合作流编号图路径</label>

													<div class="controls">

														<input type="text" name="cooperation_no" value="{{$cooperation['cooperation_no']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">匠几合作流程静图路径</label>

													<div class="controls">

														<input type="text" name="cooperation_img" value="{{$cooperation['cooperation_img']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">匠几合作流程动图路径</label>

													<div class="controls">

														<input type="text" name="cooperation_pic" value="{{$cooperation['cooperation_pic']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">匠几合作流程名称</label>

													<div class="controls">

														<input type="text" name="cooperation_name" value="{{$cooperation['cooperation_name']}}" class="m-wrap large" />
