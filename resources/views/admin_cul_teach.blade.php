				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-园训管理 <small>青蓝果教育-园训</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-园训</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="15%"><img src="{{$te->tea_pic1}}"/></td>

											<td width="15%"><img src="{{$te->tea_pic2}}"/></td>

											<td width="15%"><img src="{{$te->tea_pic3}}"/></td>

											<td>{{$te->tea_text1}}</td>

											<td>{{$te->tea_text2}}</td>

											<td><a href="/admin/culture/teach_update/{{$te->id}}">编辑</a></td>
