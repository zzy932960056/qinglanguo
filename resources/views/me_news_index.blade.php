...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅闻图文列表</div>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/me_news/index/insert/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_news/index/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除觅闻成功');
								location.href = "/me_news/index/index/"+miwenid;
							}else if(content.msg == 'no'){
								alert('发生未知错误');
								location.href = "/me_news/index/"+miwenid;
							}
						},
						dataType:"json"
					})
