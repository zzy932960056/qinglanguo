				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-环境文化管理 <small>青蓝果教育-环境文化</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-环境文化</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$e->env_pic1}}"/></td>

											<td><img src="{{$e->env_pic2}}"/></td>

											<td><img src="{{$e->env_pic3}}"/></td>

											<td><a href="/admin/env_update/{{$e->id}}">编辑</a></td>
