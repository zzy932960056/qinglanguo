					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>首页青蓝果之家</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$hi->home_pic1}}" width='425px'/></td>

											<td><img src="{{$hi->home_pic2}}" width='425px'/></td>

											<td><img src="{{$hi->home_pic3}}" width='425px'/></td>

											<td><img src="{{$hi->home_pic4}}" width='425px'/></td>

											<td><img src="{{$hi->home_pic5}}" width='425px'/></td>

											<td>{{$hi->home_text}}</td>

											<td><a href="/admin/home_info/update/{{$hi->id}}">编辑</a></td>
