								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index/doupdate/{{$news['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">首字大写段落</label>

													<div class="controls">

														<input type="text" name="big_paragraph" value="{{$news['big_paragraph']}}" class="m-wrap huge" />

														<span class="help-inline">请输入首字大写段落详情(如没有则不填)</span>
												...
												<div class="control-group">
													...
													<label class="control-label">正常段落</label>

													<div class="controls">

														<input type="text" name="small_paragraph" value="{{$news['small_paragraph']}}" class="m-wrap huge" />

														<span class="help-inline">请输入正常段落详情(如没有则不填)</span>
												...
												<div class="control-group">
													...
													<label class="control-label">样式1图片路径</label>

													<div class="controls">

														<input type="text" name="picture1" value="{{$news['picture1']}}" class="m-wrap huge" />

														<span class="help-inline">请输入样式1图片路径(如没有则不填)</span>
												...
												<div class="control-group">
													...
													<label class="control-label">样式2图片路径</label>

													<div class="controls">

														<input type="text" name="picture2" value="{{$news['picture2']}}" class="m-wrap huge" />

														<span class="help-inline">请输入样式2图片路径(如没有则不填)</span>
