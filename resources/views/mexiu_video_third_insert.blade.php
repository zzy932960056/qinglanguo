					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_xiu/video/third">觅秀视频管理</a> 
							...
							<li>
								...
								<a href="/me_xiu/video/third">觅秀视频信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">觅秀视频新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅秀视频设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅秀视频新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_xiu/video/third/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">视频封面图路径</label>

													<div class="controls">

														<input type="text" name="video_pic_path" placeholder="请输入视频封面图路径" class="m-wrap large" />

														<span class="help-inline">请输入视频封面图路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_title" placeholder="请输入视频标题" class="m-wrap large" />

														<span class="help-inline">请输入视频标题</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_describe" placeholder="请输入视频描述" class="m-wrap large" />

														<span class="help-inline">请输入视频描述</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="video_path" placeholder="请输入视频路径" class="m-wrap large" />

														<span class="help-inline">请输入视频路径</span>
