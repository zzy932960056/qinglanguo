								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/details/big_pic/doupdate/{{$details['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">青蓝果动态详情大图路径</label>

													<div class="controls">

														<input type="text" name="news_pic_b" value="{{$details['news_pic_b']}}" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态详情大图路径</span>
