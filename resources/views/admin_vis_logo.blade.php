				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-标志管理 <small>青蓝果教育-标志</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-标志</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="25%"><img src="{{$lo->logo_pic}}"/></td>

											<td>{{$lo->logo_text1}}</td>

											<td>{{$lo->logo_text2}}</td>

											<td><a href="/admin/vision/logo_update/{{$lo->id}}">编辑</a></td>
