...
<div class="cyanine-mob-container">
    ...
    <div class="cyanime-mob-crumbs">
        当前位置 ：<span><a href="/culture">青蓝果文化</a></span>-<span id="cul">视觉形象</span>
    </div>
    <!--面包屑 end-->
    <!--内容 start-->
    <div class="home-mob-container" style="background: #fefef3">
        ...
        <div class="du-cul-nav">
            <div class="cul-nav-left">
                ...
                <img src="{{URL::asset('/images/sj.jpg')}}" alt="" style="display:inline !important">
                <img src="{{URL::asset('/images_yd/hj.jpg')}}" alt="">
        ...
        <div class="cul-mob-con">
            ...
            <!--视觉形象-->
            <div class="cul-mob-items cul-mob-idea" style="display:block;">
