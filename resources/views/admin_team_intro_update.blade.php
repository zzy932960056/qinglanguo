						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几团队成员简介设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几团队成员简介设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/team/introduce/doupdate/{{$intro['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">匠几团队成员简介id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="nid" type="text" value="{{$intro['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几团队成员简介</label>

													<div class="controls">

														<input type="text" name="staff_intro" value="{{$intro['staff_intro']}}" class="m-wrap large" />

														<span class="help-inline">请输入匠几团队成员简介</span>
												...
												<div class="control-group">
													...
													<label class="control-label">当前成员id</label>

													<div class="controls">

														<input type="text" name="staff_id" value="{{$intro['staff_id']}}" readonly class="m-wrap large" />
