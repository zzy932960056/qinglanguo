								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/jiangji_mobile/cooperation/doupdate/{{$cooperation['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">匠几合作流程图路径</label>

													<div class="controls">

														<input type="text" name="process_pic" value="{{$cooperation['process_pic']}}" class="m-wrap large" />
