		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="">
					...
					<a target='_blank' href="/zcfy/qrcode">
				...
				<li class="">
					...
					<a target='_blank' href="/zcfy/upload">
				...
				<li class="">
					...
					<a href="/zcfy/database">

					<i class="icon-table"></i>

					<span class="title">数据库操作</span>
					...
					<ul class="sub-menu">
						...
						<li>
							...
							<ul class="sub-menu">
								...
								<li><a href="/admin/env">pc端环境文化</a></li>

								<li><a href="/admin/env_yd">移动端环境文化</a></li>
