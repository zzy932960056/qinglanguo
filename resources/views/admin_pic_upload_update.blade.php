						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">图片新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">图片新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/pic_doupdate" class="form-horizontal" method="post" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<img src='{{$picture['path']}}' id="fileImg" width='255'/>
														<input type="file" id="goods_file" name="goods_file"/>
														<input type="hidden" id="pic_hidden" name="pic_hidden" value="{{$picture['id']}}"/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="describe" value="{{$picture['description']}}" class="m-wrap large" />

														<span class="help-inline">请输入图片描述</span>
