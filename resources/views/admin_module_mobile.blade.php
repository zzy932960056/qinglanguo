					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几服务图文列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->service_img}}</td>

											<td><img src="{{$in->service_img}}"/></td>

											<td>{{$in->service_pic}}</td>

											<td><img src="{{$in->service_pic}}"/></td>

											<td>{{$in->service_name}}</td>

											<td><a href="/admin/jiangji_mobile/module/update/{{$in->id}}">编辑</a></td>
