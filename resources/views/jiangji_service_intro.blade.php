...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几服务简介列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><a href="/admin/jiangji/update/{{$se->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					location.href = "/admin/jiangji/insert";
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/admin/jiangji/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除简介成功');
								location.href = "/admin/jiangji";
