								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index3/fifth/doupdate/{{$news['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">模块五图片</label>

													<div class="controls">

														<input type="text" name="pic5" value="{{$news['pic5']}}" class="m-wrap huge" />

														<span class="help-inline">请输入模块五图片</span>
												...
												<div class="control-group">
													...
													<label class="control-label">模块五文本</label>

													<div class="controls">

														<input type="text" name="text5" value="{{$news['text5']}}" class="m-wrap huge" />

														<span class="help-inline">请输入模块五文本</span>
