				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-食育文化管理 <small>青蓝果教育-食育文化</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-食育文化</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$fo->clock_pic}}"/></td>

											<td><img src="{{$fo->food_pic}}"/></td>
											...
											<td><a href="/admin/food_update/{{$fo->id}}">编辑</a></td>
