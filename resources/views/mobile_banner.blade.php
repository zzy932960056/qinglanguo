				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							banner图管理 <small>移动端banner图</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>移动端banner图列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$ba->banner_path}}" width="255"/></td>

											<td>{{$ba->banner_sort}}</td>

											<td><a href="/banner/banner_mobile_pic/update/{{$ba->id}}">编辑</a></td>
