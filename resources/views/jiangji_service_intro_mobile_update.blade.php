					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/jiangji">匠几服务管理</a> 

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">匠几服务标签设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几服务简介设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几服务简介设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/jiangji_mobile/doUpdate/{{$intro['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">匠几服务简介id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几服务简介详情</label>

													<div class="controls">

														<input type="text" name="service_introduce" value="{{$intro['service_introduce']}}" class="m-wrap huge" />

														<span class="help-inline">请输入匠几服务简介详情</span>
