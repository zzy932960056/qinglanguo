					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>配套采购信息列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->purchase_mobile}}</td>

											<td><img src="{{$in->purchase_mobile}}"/></td>

											<td><a href="/admin/purchase_mobile/update/{{$in->id}}">编辑</a></td>
