					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/education/health">青蓝果教育-健康领动管理</a>
							...
							<li>
								...
								<a href="/admin/education/health">青蓝果教育-健康领动</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">青蓝果教育-健康领动设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果教育-健康领动设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果教育-健康领动设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/education/health/doupdate/{{$health['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input class="m-wrap medium" name="bid" type="text" value="{{$health['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="hea_pic1" value="{{$health['hea_pic1']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="hea_text1" value="{{$health['hea_text1']}}" class="m-wrap large" />
