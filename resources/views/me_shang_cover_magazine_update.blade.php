					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_shang/cover">觅尚首推杂志</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">觅尚首推杂志设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅尚首推杂志设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚首推杂志设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/cover/magazine/doUpdate/{{$magazine['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚首推杂志图id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚首推杂志图路径</label>

													<div class="controls">

														<input type="text" name="magazine_path" value="{{$magazine['magazine_pic']}}" class="m-wrap large" />

														<span class="help-inline">请重新输入觅尚首推杂志图路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚首推杂志图页码</label>

													<div class="controls">

														<input type="text" name="magazine_page" value="{{$magazine['magazine_page']}}" class="m-wrap large" />

														<span class="help-inline">请重新输入觅尚首推杂志图页码</span>
												...
												<div class="control-group">
													...
													<label class="control-label">当前觅尚首推id</label>

													<div class="controls">

														<input type="text" name="mid" value="{{$magazine['shang_id']}}" readonly class="m-wrap large" />
