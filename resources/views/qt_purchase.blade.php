...
<div class="top-content introduction" style="position:relative; z-index:2">
...
<div class="container-fluid" style="position:relative">
    ...
    <div class="container" style="padding-top:115px; padding-bottom: 60px; position:relative">
        ...
        <!--配套采购主体-->
        <div class="row ptcg_zhuti">
        	  <div class="col-md-12 col-xs-12 col-sm-12 jjdt_biaoti" style="margin-bottom:0vh">
            	<img src="{{URL::asset('/images/peitaocaigou_biaoti.png')}}" class="img-responsive" style="width:auto !important">
            </div>
            @foreach($purchase as $va)
            <img src="{{$va->purchase_img}}" class="img-responsive">
            @endforeach
        </div>
