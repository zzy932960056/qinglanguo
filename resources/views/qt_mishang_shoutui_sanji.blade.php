    ...
    <div data-current="book7" class="fb7" id="fb7">      
        ...
        <div id="fb7-container-book">
           ...
           <section id="fb7-deeplinking">
             <ul>
                @foreach($me_shang_first_pic as $key => $value)
                @if($key == 0)
           ...
           <section id="fb7-about" style="background:#FFF; padding-left:30px">
				<h1 style="color:#000; text-align:center; margin-bottom:30px">{{$me_shang_first['cover_theme']}}</h1>
                @foreach($me_shang_first_text as $value)
