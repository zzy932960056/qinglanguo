					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>banner图列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$ba->banner_path}}</td>

											<td><img src="{{$ba->banner_path}}"/></td>

											<td>{{$ba->banner_sort}}</td>

											<td><a href="/banner/banner_pic/update/{{$ba->id}}">编辑</a></td>
