					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/operation/screen_video">屏幕视频</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">屏幕视频设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">屏幕视频设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">屏幕视频设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/operation/doupdate/{{$video_data['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">屏幕视频id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="vid" type="text" value="{{$video_data['id']}}" disabled/>

														<span class="help-inline">当前屏幕视频id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">屏幕视频路径</label>

													<div class="controls">

														<input type="text" name="vpath" value="{{$video_data['video_path']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">屏幕视频屏幕数</label>

													<div class="controls">

														<input type="text" name="vnum" value="{{$video_data['video_screen']}}" disabled class="m-wrap large" />
