					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/navigation/navigation_image">导航大图信息管理</a> 
							...
							<li>
								...
								<a href="/navigation/navigation_image">导航大图信息</a>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">导航大图设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">导航大图设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/navigation/navigation_image/doupdate/{{$image_info['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<span class="help-inline">导航大图id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">导航大图路径</label>

													<div class="controls">

														<input type="text" name="logo" value="{{$image_info['image_path']}}" class="m-wrap large" />
