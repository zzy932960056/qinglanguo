								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index/forth/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">样式二图片路径</label>

													<div class="controls">

														<input type="text" name="picture2" placeholder="请输入样式二图片路径" class="m-wrap huge" />

														<span class="help-inline">请输入样式二图片路径</span>
