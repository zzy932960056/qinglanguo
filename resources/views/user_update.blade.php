								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/user/doupdate/{{$user['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" name="uname" type="text" value="{{$user['user_name']}}" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="password" name="upwd" placeholder="请输入新密码" class="m-wrap large" />
