        	...
        	<div class="container-fluid jinru7" style="background:#ffffff">
            	<div class="container index_mishang">
                    <a href="/index/me_shang/cover/{{$me_shang[0]->id}}">
                    	<div class="col-md-4 col-sm-4 col-xs-4 animated fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s">
                    ...
                    <a href="/index/me_shang/cover/{{$me_shang[1]->id}}">
                    	<div class="col-md-4 col-sm-4 col-xs-4 animated fadeInDown" data-wow-duration="1s" data-wow-delay="0.4s">
                            <div class="mishang_div1"><img src="{{$me_shang[1]->cover_pic}}"></div>
                            <span class="mishang_span_biankuang"></span>
                        </div>
                    </a>
                    <a href="/index/me_shang/cover/{{$me_shang[2]->id}}">
                    	<div class="col-md-4 col-sm-4 col-xs-4 animated fadeInDown" data-wow-duration="1s" data-wow-delay="0.6s" style="margin-right:0">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:center; margin-top:7vh">
                    	<a href="/index/me_shang"><div class="index_san_more animated fadeInDownBig" data-wow-duration="1s" data-wow-delay="1s">查看更多<span class="index_san_more_span" style="background:#fbdc8b"></span></div></a>
                    </div>
                </div>
