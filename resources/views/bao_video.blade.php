...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅宝视频列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$video->video_img}}" width="255"></img></td>
											...
											<td><video src="{{$video->video_path}}" controls="controls" width="220"/></td>

											<td>{{$video->is_hot == 1 ? '是' : '否'}}</td>

											<td><a href="/me_bao/video/update/{{$video->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					location.href = "/me_bao/video/insert";
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_bao/video/dodelete",
						type:"post",
						data:{'bid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除觅宝视频成功');
								location.href = "/me_bao/video";
