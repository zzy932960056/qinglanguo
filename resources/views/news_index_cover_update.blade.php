					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_news/cover">觅闻封面信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">觅闻封面图文设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅闻封面图文设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅闻封面图文设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_news/cover/index/doUpdate/{{$news['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅闻图文id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">觅闻图路径</label>

													<div class="controls">

														<input type="text" name="little_pic" value="{{$news['pic_path']}}" class="m-wrap large" />

														<span class="help-inline">请输入觅闻图路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅闻详情</label>

													<div class="controls">

														<input type="text" name="title" value="{{$news['content']}}" class="m-wrap large" />

														<span class="help-inline">请重新输入觅闻详情</span>
												...
												<div class="control-group">
													...
													<label class="control-label">当前觅闻id</label>

													<div class="controls">

														<input type="text" name="mid" value="{{$news['news_id']}}" readonly class="m-wrap large" />
