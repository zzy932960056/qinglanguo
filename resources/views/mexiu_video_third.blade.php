...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_xiu/video/third">觅秀三级视频管理</a> 
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅秀三级视频列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->video_pic_path}}</td>

											<td><img src="{{$in->video_pic_path}}" width="220"/></td>

											<td>{{$in->video_title}}</td>

											<td>{{$in->video_describe}}</td>

											<td>{{$in->video_path}}</td>

											<td><video src="{{$in->video_path}}" controls="controls" width="220"></td>

											<td><a href="/me_xiu/video/third/update/{{$in->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					location.href = "/me_xiu/video/third/insert";
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_xiu/video/third/dodelete",
						type:"post",
						data:{'cid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除视频成功');
								location.href = "/me_xiu/video/third";
