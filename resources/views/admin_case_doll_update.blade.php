						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几案例公仔图设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几案例公仔图设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/case/doll/doupdate/{{$case_doll['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" name="nid" type="text" value="{{$case_doll['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几案例公仔图1路径</label>

													<div class="controls">

														<input type="text" name="doll_pic1" value="{{$case_doll['doll_pic1']}}" class="m-wrap large" />

														<span class="help-inline">请输入匠几案例公仔图1路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几案例公仔图2路径</label>

													<div class="controls">

														<input type="text" name="doll_pic2" value="{{$case_doll['doll_pic2']}}" class="m-wrap large" />

														<span class="help-inline">请输入匠几案例公仔图2路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">匠几案例公仔图3路径</label>

													<div class="controls">

														<input type="text" name="doll_pic3" value="{{$case_doll['doll_pic3']}}" class="m-wrap large" />

														<span class="help-inline">请输入匠几案例公仔图3路径</span>
