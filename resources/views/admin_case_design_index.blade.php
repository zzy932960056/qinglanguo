					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几品牌设计列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$case_design['id']}}</td>

											<td><img src="{{$case_design['design_pic1']}}" width="355"/></td>

											<td>{{$case_design['design_text1']}}</td>

											<td><img src="{{$case_design['design_pic2']}}" width="355"/></td>

											<td>{{$case_design['design_text2']}}</td>

											<td><img src="{{$case_design['design_pic3']}}" width="355"/></td>

											<td>{{$case_design['design_text3']}}</td>

											<td><img src="{{$case_design['design_pic4']}}" width="355"/></td>

											<td>{{$case_design['design_text4']}}</td>

											<td><a href="/admin/case/design/update/{{$case_design['id']}}">编辑</a></td>
