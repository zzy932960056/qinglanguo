				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-青蓝果解析管理 <small>青蓝果教育-青蓝果解析</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-青蓝果解析</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="25%"><img src="{{$an->ana_pic}}"/></td>

											<td>{{$an->ana_text1}}</td>

											<td>{{$an->ana_text2}}</td>

											<td><a href="/admin/culture/analysis_update/{{$an->id}}">编辑</a></td>
