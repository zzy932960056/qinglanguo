					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_shang/index">觅尚杂志信息</a>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚杂志新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/index/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚杂志图路径</label>

													<div class="controls">

														<input type="text" name="magazine_path" placeholder="请输入觅尚杂志图路径" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志图路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="magazine_theme" placeholder="请输入觅尚觅尚杂志主题" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志主题</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="magazine_index" placeholder="请输入觅尚杂志主题介绍" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志主题介绍</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚杂志日期</label>

													<div class="controls">

														<input type="text" name="date" placeholder="请输入觅尚杂志觅尚杂志日期" class="m-wrap large" />

														<span class="help-inline">(格式:"2017-07-01")</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚杂志期数</label>

													<div class="controls">

														<input type="text" name="volume" placeholder="请输入觅尚杂志期数" class="m-wrap large" />

														<span class="help-inline">(格式:"第三期")</span>
