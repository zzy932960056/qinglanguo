							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚杂志段落新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/text/index/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚杂志段落内容</label>

													<div class="controls">

														<input type="text" name="magazine_text" placeholder="请输入觅尚杂志段落内容" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志段落内容</span>
