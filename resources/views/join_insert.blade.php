					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/join/index">合作伙伴信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">合作伙伴新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">合作伙伴设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">合作伙伴新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/join/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">合作伙伴种类</label>

													<div class="controls">

														<input type="text" name="kind" placeholder="请输入合作伙伴种类" class="m-wrap large" />

														<span class="help-inline">(请输入"品牌"、"媒体"、"伙伴")</span>
												...
												<div class="control-group">
													...
													<label class="control-label">合作伙伴介绍图路径</label>

													<div class="controls">

														<input type="text" name="pic_path" placeholder="请重新输入介绍图路径" class="m-wrap large" />

														<span class="help-inline">请重新输入介绍图路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">合作伙伴介绍</label>

													<div class="controls">

														<input type="text" name="introduce" placeholder="请重新输入介绍" class="m-wrap large" />

														<span class="help-inline">请重新输入介绍</span>
