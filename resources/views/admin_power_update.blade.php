						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">权限设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">权限设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/power/doupdate/{{$power['power_id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" type="text" value="{{$power['power_id']}}" disabled />

														<span class="help-inline">当前权限ID</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="power_sign" value="{{$power['power_sign']}}" class="m-wrap large" />

														<span class="help-inline">请输入权限标识</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="power_name" value="{{$power['power_name']}}" class="m-wrap large" />

														<span class="help-inline">权限名</span>
