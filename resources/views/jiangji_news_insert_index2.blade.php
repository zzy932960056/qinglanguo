								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index/second/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">正常段落详情</label>

													<div class="controls">

														<input type="text" name="small_paragraph" placeholder="请输入正常段落详情" class="m-wrap huge" />

														<span class="help-inline">请输入正常段落详情</span>
