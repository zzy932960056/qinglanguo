				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-园服管理 <small>青蓝果教育-园服</small>
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/vision/cothes">青蓝果教育-园服管理</a>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-园服</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="25%"><img src="{{$cl->clo_pic}}"/></td>
											...
											<td><a href="/admin/vision/clothes_update/{{$cl->id}}">编辑</a></td>
