						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果动态详情小图片新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果动态详情小图片新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/details/small_pic/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">青蓝果动态详情小图片1路径</label>

													<div class="controls">

														<input type="text" name="news_pic_s1" placeholder="请输入青蓝果动态详情小图片1路径" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态详情小图片1路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">青蓝果动态详情小图片2路径</label>

													<div class="controls">

														<input type="text" name="news_pic_s2" placeholder="请输入青蓝果动态详情小图片2路径" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态详情小图片2路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">青蓝果动态详情小图片3路径</label>

													<div class="controls">

														<input type="text" name="news_pic_s3" placeholder="请输入青蓝果动态详情小图片3路径" class="m-wrap huge" />

														<span class="help-inline">请输入青蓝果动态详情小图片3路径</span>
