				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-吉祥物管理 <small>青蓝果教育-吉祥物</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-吉祥物</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										@foreach($mascot as $ma)
										<tr class="">

											<td>{{$ma->id}}</td>

											<td width="50%"><img src="{{$ma->mas_pic}}"/></td>

											<td>{{$ma->mas_text}}</td>

											<td><a href="/admin/vision/mascot_update/{{$ma->id}}">编辑</a></td>
