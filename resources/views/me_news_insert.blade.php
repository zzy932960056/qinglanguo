							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅闻新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_news/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="little_pic" placeholder="请输入觅闻效果图路径" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="title" placeholder="请输入标题" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="description" placeholder="请输入觅闻描述" class="m-wrap large" />

														<span class="help-inline">请输入觅闻描述</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="kind" placeholder="请输入觅闻种类" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">觅闻头图</label>

													<div class="controls">

														<input type="text" name="head_pic" placeholder="请输入觅闻头图路径" class="m-wrap large" />

														<span class="help-inline">请输入觅闻头图路径</span>
