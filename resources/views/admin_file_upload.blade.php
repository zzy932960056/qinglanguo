					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/file_upload">本地文件管理</a> 

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="/admin/file_upload">本地文件新增</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">本地文件新增</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">本地文件新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/file_doinsert" class="form-horizontal" method="post" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<label class="control-label">上传文件必须是英文名称且不大于10M,用"URL::asset('/uploads/文件名')"调取</label>
