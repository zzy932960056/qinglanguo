					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几案例视频列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$case_video['video_pic1']}}" width="220"/></td>

											<td>{{$case_video['video_text1']}}</td>

											<td><video src="{{$case_video['video1']}}" controls="controls" width="220"></td>

											<td><img src="{{$case_video['video_pic2']}}" width="220"/></td>

											<td>{{$case_video['video_text2']}}</td>

											<td><video src="{{$case_video['video2']}}" controls="controls" width="220"></td>

											<td><img src="{{$case_video['video_pic3']}}" width="220"/></td>

											<td>{{$case_video['video_text3']}}</td>

											<td><video src="{{$case_video['video3']}}" controls="controls" width="220"></td>

											<td><img src="{{$case_video['video_pic4']}}" width="220"/></td>

											<td>{{$case_video['video_text4']}}</td>

											<td><video src="{{$case_video['video4']}}" controls="controls" width="220"></td>

											<td><a href="/admin/case/video/update/{{$case_video['id']}}">编辑</a></td>
