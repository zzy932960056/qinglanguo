								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index/first/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="big_paragraph" placeholder="请输入首字大写段落" class="m-wrap huge" />

														<span class="help-inline">请输入首字大写段落</span>
