					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_xiu/image_left">觅秀左图管理</a> 
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅秀左图信息列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$in->xiu_image_left}}</td>

											<td><img src="{{$in->xiu_image_left}}"/></td>

											<td><a href="/me_xiu/image_left/update/{{$in->id}}">编辑</a></td>
