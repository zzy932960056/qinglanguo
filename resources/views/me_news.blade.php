					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅闻列表</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										@foreach($me_news as $news)
										<tr class="">

											<td>{{$news->id}}</td>

											<td><img src="{{$news->little_pic}}" width="255"/></td>
											...
											<td><img src="{{$news->head_pic}}" width="255"/></td>

											<td><a href="/me_news/index/index/{{$news->id}}">图文详情</a></td>

											<td><a href="/me_news/update/{{$news->id}}">编辑</a></td>
	...
	<script>
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_news/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除觅闻成功');
								location.href = "/me_news/index";
