								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/purchase/doupdate/{{$jiangji_purchase['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="purchase_img" value="{{$jiangji_purchase['purchase_img']}}" class="m-wrap large" />
