					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几案例轮播图列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$case_pic['case_pic1']}}</td>

											<td><img src="{{$case_pic['case_pic1']}}" width="255"/></td>

											<td>{{$case_pic['case_pic2']}}</td>

											<td><img src="{{$case_pic['case_pic2']}}" width="255"/></td>

											<td>{{$case_pic['case_pic3']}}</td>

											<td><img src="{{$case_pic['case_pic3']}}" width="255"/></td>

											<td><a href="/admin/case/pic/update/{{$case_pic['id']}}">编辑</a></td>
