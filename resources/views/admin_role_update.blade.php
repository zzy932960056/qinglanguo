						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">角色设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">角色设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/role/doupdate/{{$role['role_id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" type="text" value="{{$role['role_id']}}" disabled />

														<span class="help-inline">当前角色ID</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="role_sign" value="{{$role['role_sign']}}" class="m-wrap large" />

														<span class="help-inline">请输入角色标识</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="role_name" value="{{$role['role_name']}}" class="m-wrap large" />

														<span class="help-inline">角色名</span>
