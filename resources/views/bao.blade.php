...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅宝列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$ba->picture}}" width="150"/></td>

											<td><img src="{{$ba->picture_big}}" width="220"/></td>

											<td>{{$ba->shop}}</td>

											<td>{{$ba->collocation}}</td>

											<td>{{$ba->taobao}}</td>

											<td>{{$ba->is_hot == 1 ? '是' : '否'}}</td>

											<td><img src="{{$ba->hot_pic}}"/></td>
											
											<td><a href="/me_bao/index/update/{{$ba->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					location.href = "/me_bao/index/insert";
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					$.ajax({
						url:"/me_bao/index/dodelete",
						type:"post",
						data:{'bid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除觅宝成功');
								location.href = "/me_bao/index";
