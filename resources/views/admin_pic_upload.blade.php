				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/admin/pic_upload">图片新增</a></li>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/pic_doinsert" class="form-horizontal" method="post" enctype="multipart/form-data">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="describe" placeholder="请输入图片描述" class="m-wrap large" />
