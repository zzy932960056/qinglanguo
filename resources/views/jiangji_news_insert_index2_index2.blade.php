								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index2/second/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="ul_li" placeholder="请输入ul-li标签段落详情" class="m-wrap huge" />

														<span class="help-inline">请输入ul-li标签段落详情</span>
