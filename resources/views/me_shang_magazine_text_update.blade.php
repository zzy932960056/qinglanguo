						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅尚杂志段落设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚杂志段落设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/text/index/doUpdate/{{$magazine['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚杂志段落id</label>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚杂志段落</label>

													<div class="controls">

														<input type="text" name="magazine_text" value="{{$magazine['magazine_text']}}" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志段落</span>
