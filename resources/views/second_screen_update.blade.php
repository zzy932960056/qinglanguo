								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/second/second_screen/doupdate/{{$second_data['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" name="sid" type="text" value="{{$second_data['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<label class="control-label">logo图片路径</label>

													<div class="controls">

														<input type="text" name="logo" value="{{$second_data['logo_pic']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">公仔图片路径</label>

													<div class="controls">

														<input type="text" name="doll" value="{{$second_data['doll_pic']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">文本一</label>

													<div class="controls">

														<input type="text" name="text1" value="{{$second_data['text_one']}}" class="m-wrap huge" />

														<span class="help-inline">请输入新文本</span>
												...
												<div class="control-group">
													...
													<label class="control-label">文本二</label>

													<div class="controls">

														<input type="text" name="text2" value="{{$second_data['text_two']}}" class="m-wrap huge" />
												...
												<div class="control-group">
													...
													<label class="control-label">文本三</label>

													<div class="controls">

														<input type="text" name="text3" value="{{$second_data['text_three']}}" class="m-wrap huge" />
