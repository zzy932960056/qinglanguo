					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/admin">管理员</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="/admin/update">管理员设置</a></li>
								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/doupdate/{{$admin['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">   
														...
														<input class="m-wrap medium" name="uname" type="text" value="{{$admin['username']}}" />
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<select name="arole" class="small m-wrap" tabindex="1">
															@foreach($role as $ro)
															<option value="{{$role_name}}">{{$ro->role_name}}</option>
															@endforeach
														</select>
