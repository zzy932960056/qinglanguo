					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅样尾页信息列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$in->wechat}}"/></td>

											<td><img src="{{$in->weibo}}"/></td>

											<td><img src="{{$in->taobao}}"/></td>
											...
											<td><img src="{{$in->map_image}}"/></td>

											<td>{{$in->join_us1}}</td>

											<td>{{$in->join_us2}}</td>

											<td><a href="/melast/melast/update/{{$in->id}}">编辑</a></td>
