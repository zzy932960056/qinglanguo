...
<div class="container-fluid" style="margin-top:80px;">
	<div class="row index_zhuti_title"><img src="{{URL::asset('/yd_images/jiangjidongtai_sanji_title.png')}}" class="img-responsive"></div>
		...
		@if($va->big_paragraph)
		<div class="row jjdt_sanji3_1">
            <p>{!! $va->big_paragraph !!}</p>
        </div>
        @elseif($va->small_paragraph)
        <div class="row jjdt_sanji3_1">
            <p>{!! $va->small_paragraph !!}</p>
        </div>
        @elseif($va->picture1)
		<div class="row jjdt_sanji3_1" style="padding-right:15px; margin:50px auto">
            <div class="jjdt_sanji2_nr_img1"><span></span><img src="{{$va->picture1}}" class="img-responsive"></div>
		</div>
		@elseif($va->picture2)
		<div class="row jjdt_sanji3_1" style="padding-right:15px; padding-left:15px; margin:50px auto">
			<div class="jjdt_sanji2_nr_img2"><span></span><img src="{{$va->picture2}}" class="img-responsive"></div>
		</div>
		@endif
		@endforeach
