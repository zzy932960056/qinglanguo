								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/culture_mobile/doupdate/{{$jiangji_culture['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="jiangji_culture" value="{{$jiangji_culture['jiangji_culture']}}" class="m-wrap large" />
