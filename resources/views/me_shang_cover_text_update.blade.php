					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_shang/cover">觅尚首推文字</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">觅尚首推文字设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅尚首推文字设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚首推文字设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/cover/text/doUpdate/{{$text['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚首推文字id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="nid" type="text" value="{{$text['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚首推文字</label>

													<div class="controls">

														<input type="text" name="title" value="{{$text['magazine_text']}}" class="m-wrap large" />

														<span class="help-inline">请重新输入觅尚首推文字</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="mid" value="{{$text['shang_id']}}" readonly class="m-wrap large" />
