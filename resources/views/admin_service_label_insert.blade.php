						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">匠几服务标签详情设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">匠几服务标签详情新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/service/label/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">匠几服务标签</label>

													<div class="controls">

														<input type="text" name="service_label" placeholder="请输入匠几服务标签" class="m-wrap large" />

														<span class="help-inline">请输入匠几服务标签</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="service_id" value="{{$service_id}}" readonly class="m-wrap large" />
