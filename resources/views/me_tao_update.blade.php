						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅淘设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅淘设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/metao/metao/doupdate/{{$me_tao['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">觅淘id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="tid" type="text" value="{{$me_tao['id']}}" disabled/>

														<span class="help-inline">觅淘id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅淘图片路径</label>

													<div class="controls">

														<input type="text" name="image" value="{{$me_tao['image_path']}}" class="m-wrap large" />
