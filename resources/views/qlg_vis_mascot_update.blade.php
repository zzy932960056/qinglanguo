					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/vision/mascot">青蓝果教育-吉祥物管理</a>
							...
							<li>
								...
								<a href="/admin/vision/mascot">青蓝果教育-吉祥物</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">青蓝果教育-吉祥物设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果教育-吉祥物设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果教育-吉祥物设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/vision/mascot/doupdate/{{$mascot['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input class="m-wrap medium" name="bid" type="text" value="{{$mascot['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="mas_pic" value="{{$mascot['mas_pic']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">段落文本</label>

													<div class="controls">

														<input type="text" name="mas_text" value="{{$mascot['mas_text']}}" class="m-wrap large" />

														<span class="help-inline">请输入段落文本</span>
