...
<div class="container-fluid" style="margin-top:-20px;">
    ...
    <div class="row index_mixiu">
		...
		<div class="col-xs-12 wow animated fadeInDown more">
			<a href="/index/me_xiu/third"><img src="{{URL::asset('/images_yd/mixou_more.png')}}" class="img-responsive"></a>
        </div>
...
<style>
    .mixiu_banner{width:100%; height:30vh; background:url({{$banner_xiu['banner_path']}}) no-repeat center center; background-size:cover}
</style>    
</html>
