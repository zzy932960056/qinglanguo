						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅闻封面详情设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅闻封面详情新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_news/cover/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅闻详情图片</label>

													<div class="controls">

														<input type="text" name="index_pic" placeholder="请输入觅闻详情图片路径" class="m-wrap large" />

														<span class="help-inline">请输入觅闻详情图片路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="index" placeholder="请输入觅闻详情" class="m-wrap large" />

														<span class="help-inline">请输入觅闻详情</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅闻关联id</label>
