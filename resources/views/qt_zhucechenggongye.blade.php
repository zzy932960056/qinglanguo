...
<div class="index_zhuce" style="text-align:center">
	<a href="/"><img src="{{URL::asset('/images/logo.png')}}" class="img-responsive index_zhuce_logo"></a>
    <div style="width:80%; margin-left:10%; margin-bottom:5vh; margin-top:-5vh">
    	<img src="{{URL::asset('/images/zhucechenggong.png')}}" class="img-responsive" style="width:100%">
    </div>
	<a href="/" style="width:50%; display: inline-block; margin:0 auto; display:inline-block; height:5vh; line-height:5vh; font-size:16px !important; color:#545454; background:#fdb800; border:0; border-radius:5px">返回首页</a>
</div>
