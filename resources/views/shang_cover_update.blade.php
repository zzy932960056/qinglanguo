						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">觅尚首推设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚首推设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/cover/doupdate/{{$shang['id']}}" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚首推杂志id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="sid" type="text" value="{{$shang['id']}}" readonly/>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚首推杂志封面图路径</label>

													<div class="controls">

														<input type="text" name="cover_pic" value="{{$shang['cover_pic']}}" class="m-wrap large" />

														<span class="help-inline">请输入觅尚首推杂志封面图路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">觅尚首推杂志主题</label>

													<div class="controls">

														<input type="text" name="cover_theme" value="{{$shang['cover_theme']}}" class="m-wrap large" />

														<span class="help-inline">请输入觅尚首推杂志主题</span>
