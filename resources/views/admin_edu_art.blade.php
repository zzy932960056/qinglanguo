				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-艺术创想管理 <small>青蓝果教育-艺术创想</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-艺术创想</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="25%"><img src="{{$ar->art_pic1}}"/></td>

											<td>{{$ar->art_text1}}</td>

											<td><a href="/admin/education/art_update/{{$ar->id}}">编辑</a></td>
