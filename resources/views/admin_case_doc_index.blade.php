					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几品牌文案列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$case_doc['document_pic1']}}" width="355"/></td>

											<td>{{$case_doc['document_text1']}}</td>

											<td><img src="{{$case_doc['document_pic2']}}" width="355"/></td>

											<td>{{$case_doc['document_text2']}}</td>

											<td><img src="{{$case_doc['document_pic3']}}" width="355"/></td>

											<td>{{$case_doc['document_text3']}}</td>

											<td><img src="{{$case_doc['document_pic4']}}" width="355"/></td>

											<td>{{$case_doc['document_text4']}}</td>

											<td><a href="/admin/case/doc/update/{{$case_doc['id']}}">编辑</a></td>
