					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>觅尚首推列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$shang->cover_pic}}</td>

											<td><img src="{{$shang->cover_pic}}" width="255"/></td>

											<td>{{$shang->cover_theme}}</td>

											<td><a href="/me_shang/cover/text/{{$shang->id}}">杂志文字详情</a></td>

											<td><a href="/me_shang/cover/magazine/{{$shang->id}}">杂志页面详情</a></td>

											<td><a href="/me_shang/cover/update/{{$shang->id}}">编辑</a></td>
