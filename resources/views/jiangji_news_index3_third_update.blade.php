								...
								<div class="tabbable portlet-tabs">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/news/third/index3/third/doupdate/{{$news['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<label class="control-label">模块三图片路径</label>

													<div class="controls">

														<input type="text" name="pic3" value="{{$news['pic3']}}" class="m-wrap huge" />

														<span class="help-inline">请输入模块三图片路径</span>
												...
												<div class="control-group">
													...
													<label class="control-label">模块三文3.1</label>

													<div class="controls">

														<input type="text" name="text3_1" value="{{$news['text3_1']}}" class="m-wrap huge" />

														<span class="help-inline">请输入模块三文3.1</span>
												...
												<div class="control-group">
													...
													<label class="control-label">模块三文3.2</label>

													<div class="controls">

														<input type="text" name="text3_2" value="{{$news['text3_2']}}" class="m-wrap huge" />

														<span class="help-inline">请输入模块三文3.2</span>
