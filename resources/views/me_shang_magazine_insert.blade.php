					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/me_news/cover">觅尚杂志信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">觅尚杂志页新增</a></li>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">觅尚杂志页新增</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/me_shang/magazine/doinsert" class="form-horizontal" method="post">

												<div class="control-group">

													<label class="control-label">觅尚杂志图片路径</label>

													<div class="controls">

														<input type="text" name="magazine_pic" placeholder="请输入觅尚杂志图片路径" class="m-wrap large" />

														<span class="help-inline">请输入觅尚杂志图片路径</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="magazine_page" placeholder="请输入觅尚杂志页码" class="m-wrap large" />

														<span class="help-inline">(页码不能重复,请谨慎输入)</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="shang_id" value="{{$shang_id}}" readonly class="m-wrap large" />
