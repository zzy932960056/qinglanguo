				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-青蓝果动态头图管理 <small>青蓝果教育-青蓝果动态头图</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-青蓝果动态头图</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										@foreach($picture as $pi)
										<tr class="">

											<td>{{$pi->id}}</td>

											<td><img src="{{$pi->news_pic}}"/></td>

											<td>{{$pi->pic_sort}}</td>

											<td><a href="/admin/news/picture_yd_update/{{$pi->id}}">编辑</a></td>
