					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/purchase">配套采购信息管理</a> 
							...
							<li>
								...
								<a href="/admin/purchase">配套采购信息</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">配套采购设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">配套采购设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">配套采购设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/purchase_mobile/doupdate/{{$jiangji_purchase['id']}}" class="form-horizontal" method="post">
												
												<div class="control-group">

													<label class="control-label">配套采购信息id</label>

													<div class="controls">   

														<input class="m-wrap medium" name="tid" type="text" value="{{$jiangji_purchase['id']}}" disabled/>

														<span class="help-inline">配套采购信息id</span>
												...
												<div class="control-group">
													...
													<label class="control-label">配套采购图片路径</label>

													<div class="controls">

														<input type="text" name="purchase_mobile" value="{{$jiangji_purchase['purchase_mobile']}}" class="m-wrap large" />
