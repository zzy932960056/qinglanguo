...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几服务标签列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td id="ser_id">{{$la->service_id}}</td>

											<td><a href="/admin/service/label/update/{{$la->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					var hid = $('#hidden').val();
					location.href = "/admin/service/label/insert/"+hid;
				}
			)
		...
		$(".delete").click(
				function(othis){
					...
					var ser_id = $("#ser_id").html();
					$.ajax({
						url:"/admin/service/label/dodelete",
						type:"post",
						data:{'mid':data},
						success:function(content){
							if(content.msg == 'ok'){
								alert('删除标签成功');
								location.href = "/admin/service/label/"+ser_id;
