				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							青蓝果教育-青蓝精神管理 <small>青蓝果教育-青蓝精神</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>青蓝果教育-青蓝精神</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td width="25%"><img src="{{$sp->spi_pic1}}"/></td>

											<td width="25%"><img src="{{$sp->spi_pic2}}"/></td>

											<td width="25%"><img src="{{$sp->spi_pic3}}"/></td>

											<td>{{$sp->spi_text1}}</td>

											<td>{{$sp->spi_text2}}</td>

											<td><a href="/admin/culture/spirit_update/{{$sp->id}}">编辑</a></td>
