					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/culture/purpose">青蓝果教育-办园宗旨管理</a>
							...
							<li>
								...
								<a href="/admin/culture/purpose">青蓝果教育-办园宗旨</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">青蓝果教育-办园宗旨设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果教育-办园宗旨设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果教育-办园宗旨设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/culture/purpose/doupdate/{{$purpose['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input class="m-wrap medium" name="bid" type="text" value="{{$purpose['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="pur_pic" value="{{$purpose['pur_pic']}}" class="m-wrap large" />
