				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/admin/role/insert">角色新增</a></li>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">管理员角色设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/role/doinsert" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="sign" placeholder="请输入标识名" class="m-wrap large" />

														<span class="help-inline">请输入标识名(如:administrator、operator、editor)</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="sname" placeholder="请输入名称" class="m-wrap large" />

														<span class="help-inline">请输入名称(如:超级管理员、运营人员、编辑人员)</span>
