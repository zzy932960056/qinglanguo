					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>第二屏信息列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$in->logo_pic}}"/></td>

											<td>{{$in->doll_pic}}</td>

											<td><img src="{{$in->doll_pic}}"/></td>
											...
											<td><a href="/second/second_screen/update/{{$in->id}}">编辑</a></td>
