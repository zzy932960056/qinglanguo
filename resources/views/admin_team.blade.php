...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几团队成员列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$te->staff_pic1}}" width="155"/></td>

											<td><img src="{{$te->staff_pic2}}" width="155"/></td>

											<td><img src="{{$te->staff_alert}}" width="155"/></td>

											<td><img src="{{$te->mobile_pic1}}" width="155"/></td>

											<td><img src="{{$te->mobile_pic2}}" width="155"/></td>

											<td><img src="{{$te->mobile_alert}}" width="155"/></td>

											<td>{{$te->sort_no}}</td>

											<td><a href="/admin/team/introduce/{{$te->id}}">个人简介</a></td>

											<td><a href="/admin/team/update/{{$te->id}}">编辑</a></td>
	...
	<script>
		...
		$("#sample_editable_1_new").click(
				function(){
					location.href = "/admin/team/insert";
				}
			)
