					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="/admin/culture/team">青蓝果教育-团队文化管理</a>
							...
							<li>
								...
								<a href="/admin/culture/team">青蓝果教育-团队文化</a>

								<span class="icon-angle-right"></span>

							</li>

							<li><a href="#">青蓝果教育-团队文化设置</a></li>
						...
						<div class="portlet box blue tabbable">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<span class="hidden-480">青蓝果教育-团队文化设置</span>
							...
							<div class="portlet-body form">
								...
								<div class="tabbable portlet-tabs">
									...
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">青蓝果教育-团队文化设置</a></li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="/admin/culture/team/doupdate/{{$team['id']}}" class="form-horizontal" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input class="m-wrap medium" name="bid" type="text" value="{{$team['id']}}" disabled/>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="text" name="team_pic" value="{{$team['team_pic']}}" class="m-wrap large" />
												...
												<div class="control-group">
													...
													<label class="control-label">文本1</label>

													<div class="controls">

														<input type="text" name="team_text1" value="{{$team['team_text1']}}" class="m-wrap large" />

														<span class="help-inline">请输入文本1</span>
												...
												<div class="control-group">
													...
													<label class="control-label">文本2</label>

													<div class="controls">

														<input type="text" name="team_text2" value="{{$team['team_text2']}}" class="m-wrap large" />

														<span class="help-inline">请输入文本2</span>
