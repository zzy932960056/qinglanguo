...
<div class="cyanine-mob-container">
    ...
    <div class="cyanime-mob-crumbs">
        当前位置 ：<span><a href="/culture">青蓝果文化</a></span>-<span id="cul">食育文化</span>
    </div>
    <!--面包屑 end-->
    <!--内容 start-->
    <div class="home-mob-container" style="background: #fefef3">
        ...
        <div class="du-cul-nav">
            <div class="cul-nav-left">
                ...
                <img src="{{URL::asset('/images_yd/hj.jpg')}}" alt="" style="display:none">
                <img src="{{URL::asset('/images/food-tit.jpg')}}" alt="" style="display:inline !important">
            </div>
        ...
        <div class="cul-mob-con">
            ...
            <!--环境文化-->
            <div class="cul-mob-items cul-mob-ambient">
                <img src="{{$env[0]->env_pic1}}" alt="">
                <img src="{{$env[0]->env_pic2}}" alt="">
            </div>
            <!--食育文化-->
            <ul class="du-cul-content cul-mob-items" style="display:block;">
