					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>联系匠几大图列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td>{{$re->contact_mobile}}</td>

											<td><img src="{{$re->contact_mobile}}"/></td>

											<td><a href="/admin/relation_mobile/update/{{$re->id}}">编辑</a></td>
