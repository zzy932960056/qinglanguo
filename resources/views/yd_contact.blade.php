...
<div class="container-fluid" style="margin-top:260px">
    ...
    <div class="row lxjj_daceng">
    	<img src="{{$contact->contact_mobile}}" class="img-responsive">
        <img src="{{URL::asset('/yd_images/lianxijiangji_dian.gif')}}" class="img-responsive lijj_dian">
    </div>
