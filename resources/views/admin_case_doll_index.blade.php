					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>匠几案例公仔图列表</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr class="">
											...
											<td><img src="{{$case_doll['doll_pic1']}}" width="355"/></td>

											<td><img src="{{$case_doll['doll_pic2']}}" width="355"/></td>

											<td><img src="{{$case_doll['doll_pic3']}}" width="355"/></td>

											<td><a href="/admin/case/doll/update/{{$case_doll['id']}}">编辑</a></td>
